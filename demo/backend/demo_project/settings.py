...
CSRF_TRUSTED_ORIGINS = ['https://nis2-shield-demo-production.up.railway.app']
...
# NIS2 Shield - all secrets from environment
NIS2_SHIELD = {
    'INTEGRITY_KEY': os.environ.get('NIS2_INTEGRITY_KEY', 'demo-change-in-production'),
    'ANONYMIZE_IPS': True,
